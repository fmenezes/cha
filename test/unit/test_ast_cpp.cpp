...
void test_constant_nodes() {
  ...
  assert(int_const->result_type()->as_primitive().type ==
...
void test_types() {
  ...
  assert(array_type->as_array().element_type->as_primitive().type ==
...
int main() {
  ...
  try {
    ...
    std::cout << "\n✅ All tests passed! C++ AST implementation is working "
                 "correctly.\n";
    return 0;
