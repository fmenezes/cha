...
void ni::codegen::llvmir::llvmir_codegen::visit(
...
void ni::codegen::llvmir::llvmir_codegen::visit(const ni::ast::program &node) {
  for (auto &instruction : node.instructions) {
    ni::ast::visitor::visit(*instruction);
  }
}

ni::codegen::llvmir::llvmir_codegen::~llvmir_codegen() {
  delete builder;
  delete mod;
  delete ctx;
}

void ni::codegen::llvmir::llvmir_codegen::generate(const std::string &output) {
